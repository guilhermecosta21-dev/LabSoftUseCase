...
class Program
{
    ...
    */
    private static DateTime LerDataValida(string mensagemPrompt)
    {
        ...
        string[] formatoAceitos = { "dd/MM/yyyy", "d/M/yyyy" };
        ...
        while (true)
        {
            ...
            if (DateTime.TryParseExact(entrada, formatoAceitos, CultureInfo.InvariantCulture, DateTimeStyles.None, out dataResultado))
            {
